...
def _serialize_return(r):
    ...
    return {
        ...
        "receiptVerifyStatus": r.receipt_verify_status,
        "receiptVerifyReason": r.receipt_verify_reason,
...
def _upsert_return(data):
    ...
    ret, _ = ReturnRequest.objects.update_or_create(
        ...
        defaults={
            ...
            "receipt_verify_status": data.get("receiptVerifyStatus"),
            "receipt_verify_reason": data.get("receiptVerifyReason"),
